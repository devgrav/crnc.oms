	...
	return{
		...
		plugins: [
			...
			new webpack.EnvironmentPlugin({
				...
				REACT_APP_SECURITY_API_URL: env.REACT_APP_SECURITY_API_URL || 'http://localhost:64707/api',
				REACT_APP_SALES_API_URL: env.REACT_APP_SALES_API_URL || 'http://localhost:64708/api'
				})
		],
		devServer: {
			hot: true,
